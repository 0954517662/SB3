                ...
                if op.param3 in Bots:
                    if op.param2 not in Bots and op.param2 not in Team:
                        ...
                        try:
                            ...
                            try:
                                if op.param3 not in wait["blacklist"]:
                                    ka.findAndAddContactsByMid(op.param1,[Zmid])
                                    ka.kickoutFromGroup(op.param1,[op.param2])
                                    ka.inviteIntoGroup(op.param1,[Zmid])
                            except:
                                try:
                                    if op.param3 not in wait["blacklist"]:
                                       kb.findAndAddContactsByMid(op.param1,[Zmid])
                              ...
                              if spl == 'on':
                                  ...
                                  cl.sendMessage(msg.to, "active\n\n" + msgs)
                                    ...
                                    if msg.to in protect["antijs"]:
                                         ...
                                         ginfo = cl.getGroup(msg.to)
                                         msgs = "Protectjs has been deactive\ηin group : " +str(ginfo.name)
                                    else:
